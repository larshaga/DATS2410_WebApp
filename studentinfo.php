...
//    $sql = "select c.title as 'Course name', g.year, g.grade from Student s, Grade g, Course c where s.stID=g.stID and
//    g.coursecode=c.coursecode and g.year=c.year and s.stID=XXXXXXXXX;";
//    $result = $dbconn->query($sql);
